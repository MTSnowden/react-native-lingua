// Typography tokens from the design system (see prompt_material/01-design-system.png).
// Mirrors the `--font-*` tokens and `heading-*`/`body-*`/`caption` utilities in
// `global.css`. Use these only where NativeWind className isn't supported.
